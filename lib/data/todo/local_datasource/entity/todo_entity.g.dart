...
extension GetTodoEntityCollection on Isar {
  IsarCollection<TodoEntity> get todo => this.collection();
}
...
extension TodoEntityQueryWhere
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterWhereClause> idIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterWhereClause> idIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterWhereClause> idEqualTo(
      String? id) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'id',
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterWhereClause> idGreaterThan(
    String? id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterWhereClause> idLessThan(
    String? id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterWhereClause> idBetween(
    String? lowerId,
    String? upperId, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterWhereClause> idStartsWith(
      String IdPrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'id',
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterWhereClause> idIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'id',
        value: [''],
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterWhereClause> idIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension TodoEntityQueryFilter
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterFilterCondition> idIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'id',
      ));
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterFilterCondition> idIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'id',
      ));
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterFilterCondition> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'name',
      ));
  ...
  QueryBuilder<TodoEntity, TodoEntity, QAfterFilterCondition> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'name',
      ));
